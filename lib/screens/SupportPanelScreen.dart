...
class SupportPanelScreen extends StatefulWidget {
  @override
  _SupportPanelScreenState createState() => _SupportPanelScreenState();
}

class _SupportPanelScreenState extends State<SupportPanelScreen> {
              ...
              child: ListView(children: [
                for (var model in categoryModels)
                  Padding(
                      ...
                      child: CategoryCardSupport(model))
              ]),
            ),
          ],
        ),
